...
order specified.`,
  ...
  atl jira board rank PROJ-123 --before PROJ-456

  # Rank an issue after another
  atl jira board rank PROJ-123 --after PROJ-456

  # Rank multiple issues in order before a target
  atl jira board rank PROJ-123 PROJ-124 PROJ-125 --before PROJ-456

  # Move issues to top of backlog (requires board ID)
  atl jira board rank PROJ-123 PROJ-124 --top --board-id 42

  # Output as JSON
  atl jira board rank PROJ-123 --before PROJ-456 --json`,
