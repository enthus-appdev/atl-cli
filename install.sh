...
print_next_steps() {
    ...
    echo ""
    echo "     ${BLUE}atl auth login${NC}"
    echo ""
    echo "  3. Start using the CLI:"
    echo ""
    echo "     ${BLUE}atl issue list --assignee @me${NC}"
    echo "     ${BLUE}atl confluence space list${NC}"
    echo ""
    echo "For help, run: ${BLUE}atl --help${NC}"
    echo ""
}
