...
func runSetup(opts *SetupOptions) error {
	...
	if opts.Interactive {
		...
		fmt.Fprintln(opts.IO.Out, "    • Next to \"OAuth 2.0 (3LO)\", click "+output.Bold.Render("Add"))
		...
		fmt.Fprintln(opts.IO.Out, "")
		fmt.Fprintln(opts.IO.Out, "    • Click "+output.Bold.Render("Add")+" and then "+output.Bold.Render("Configure")+" next to \"Jira API\"")
		fmt.Fprintln(opts.IO.Out, "    • In the "+output.Bold.Render("Classic Scopes")+" tab, click "+output.Bold.Render("Edit Scopes")+" to enable the following 3 scopes:")
		...
		fmt.Fprintln(opts.IO.Out, "    • In the "+output.Bold.Render("Granular Scopes")+" tab, click "+output.Bold.Render("Edit Scopes")+" to enable the following 4 or 10 scopes:")
		...
		fmt.Fprintln(opts.IO.Out, "        "+output.Faint.Render("read:cmdb-object:jira"))
		fmt.Fprintln(opts.IO.Out, "        "+output.Faint.Render("read:cmdb-schema:jira"))
		fmt.Fprintln(opts.IO.Out, "      For boards/sprints/ranking, also enable:")
		...
		fmt.Fprintln(opts.IO.Out, "")
		fmt.Fprintln(opts.IO.Out, "    • Click "+output.Bold.Render("Permissions")+" in the left menu (you should see \"Jira API\" with 7 or 13 scopes used)")
		fmt.Fprintln(opts.IO.Out, "    • Click "+output.Bold.Render("Add")+" and then "+output.Bold.Render("Configure")+" next to \"Confluence API\"")
		fmt.Fprintln(opts.IO.Out, "    • In the "+output.Bold.Render("Classic Scopes")+" tab, click "+output.Bold.Render("Edit Scopes")+" to enable the following 3 scopes:")
		...
		fmt.Fprintln(opts.IO.Out, "    • In the "+output.Bold.Render("Granular Scopes")+" tab, click "+output.Bold.Render("Edit Scopes")+" to enable the following 14 scopes:")
		...
		fmt.Fprintln(opts.IO.Out, "        "+output.Faint.Render("delete:page:confluence"))
		...
		fmt.Fprintln(opts.IO.Out, "        "+output.Faint.Render("read:folder:confluence"))
		fmt.Fprintln(opts.IO.Out, "        "+output.Faint.Render("write:folder:confluence"))
		fmt.Fprintln(opts.IO.Out, "        "+output.Faint.Render("delete:folder:confluence"))
